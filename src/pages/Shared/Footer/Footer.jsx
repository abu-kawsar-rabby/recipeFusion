...
const Footer = () => {
    return (
        <footer>
            <div className="footer px-28 mt-10 p-10 bg-base-200 text-base-content">
                <div>
                    ...
                    <p>Providing reliable recipe since 2020</p>
                </div>
                <div>
            ...
            <div className="footer px-28 items-center p-4 bg-neutral text-neutral-content">
